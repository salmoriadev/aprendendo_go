...
func (e *AssinaturaPkcs1v15) Assinar(resumo []byte,
	...
	assinatura, err := rsa.SignPKCS1v15(rand.Reader,
		chavePrivada, crypto.SHA256, resumo)
	if err != nil {
...
func (e *AssinaturaPkcs1v15) VerificarAssinatura(resumo,
	assinatura []byte, chavePublica *rsa.PublicKey) error {
	err := rsa.VerifyPKCS1v15(chavePublica,
		crypto.SHA256, resumo, assinatura)
	if err != nil {
		return fmt.Errorf(
